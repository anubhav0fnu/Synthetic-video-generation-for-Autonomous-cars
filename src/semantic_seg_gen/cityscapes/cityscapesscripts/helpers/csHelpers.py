...
try:
    ...
    # it actually tells that the SYNTAX ERROR lies in helpers.csHelpers.py module at line 239, Need to comment it.!
    print(e) # Tried to print the error as the below print statement was deceving.!!!
