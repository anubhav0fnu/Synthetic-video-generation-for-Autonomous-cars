...
os.environ['CITYSCAPES_DATASET'] = "/home/ubuntu/Documents/anubhav/deep_lab_dataset/cityscapes/"
...
def main():
    ...
    print('searchFine PTH',searchFine)
    print('searchCoarse PTH', searchCoarse)
