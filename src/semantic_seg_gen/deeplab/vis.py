...
def main(unused_argv):
  ...
  with g.as_default():
    ...
    while (FLAGS.max_number_of_iterations <= 0 or
      ...
      # FIXME, the original code need to train & eval simultaneously.
      # last_checkpoint = slim.evaluation.wait_for_new_checkpoint(
      #     FLAGS.checkpoint_dir, last_checkpoint)

      # FIXME , this will allow the vis to evaluate the evaluation set without waiting for next checkpoint.
      ...
      with sv.managed_session(FLAGS.master,
        ...
        sv.saver.restore(sess, tf.train.latest_checkpoint(last_checkpoint))
