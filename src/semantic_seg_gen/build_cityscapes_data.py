...
Added:
        The cityscapesscripts folder are in the "git clone https://github.com/mcordts/cityscapesScripts.git"
  + cityscapes
...
def _convert_dataset(dataset_split):
  ...
  print('Total num of images% & in each shard %', num_images, num_per_shard)
  #use method of build_data.py script.
